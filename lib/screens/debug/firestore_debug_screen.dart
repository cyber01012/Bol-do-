...
class _FirestoreDebugScreenState extends State<FirestoreDebugScreen> with SingleTickerProviderStateMixin {
        ...
        children: [
          ...
          SingleChildScrollView(
            ...
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                // Realtime synchronization header widget
                Row(
                ...
                // SECTION 3: REALTIME ORCHESTRATION STREAM
                Text(
                ...
                // SECTION 4: TRACE INSPECTOR (LIMITED TO 20 DESCENDING)
                Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [
                    Text(
                    ...
                    GestureDetector(
                      onTap: () {
                        // Navigate to full logs screen using the latest session ID
                ...
                // SECTION 2: LIVE COLLECTION STATUS
                Text(
